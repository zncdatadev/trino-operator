...
func makeIngress(ctx context.Context, instance *stackv1alpha1.Trino, schema *runtime.Scheme) *v1.Ingress {
...
// make pvc
func makePVC(ctx context.Context, instance *stackv1alpha1.Trino, schema *runtime.Scheme) *corev1.PersistentVolumeClaim {
	logger := log.FromContext(ctx)
	labels := instance.GetLabels()
...
// reconcilePVC
func (r *TrinoReconciler) reconcilePVC(ctx context.Context, instance *stackv1alpha1.Trino) error {
	logger := log.FromContext(ctx)
	pvc := &corev1.PersistentVolumeClaim{}
...
// make service
func makeService(ctx context.Context, instance *stackv1alpha1.Trino, schema *runtime.Scheme) *corev1.Service {
	labels := instance.GetLabels()
	svc := &corev1.Service{
		ObjectMeta: metav1.ObjectMeta{
			Name:        instance.Name,
...
func makeDeployment(ctx context.Context, instance *stackv1alpha1.Trino, schema *runtime.Scheme) *appsv1.Deployment {
	labels := instance.GetLabels()
